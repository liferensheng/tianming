<template>
    <div class="background">
        <My_header title="订单评价"></My_header>
        <div class="items_top">
            <div class="goods_pic">
        ...
        <div class="choose">
            <button class="active">好评</button>
            <button>中评</button>
            <button>差评</button>
        </div>
        <div class="contain">
            <div  class="suggestion">
                <textarea rows="4" placeholder="请输入评价" v-model="suggestion"></textarea>
                <span class="left-word">200</span>
            </div>
            <div class="line"></div>
            <ul class="upload">
                <li class="list">
        ...
        <div class="button" @click="to_me">发布</div>
    </div>
</template>
<script>
