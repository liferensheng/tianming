<template>
    <div class="raise">
        <My_header title="众筹详情"></My_header>
        <div class="raise_order">
            <div class="send_goods">
                ...
                <div class="store_info">
                    ...
                    <div class="presses">
                        <div class="presses_now">当前进度</div>
                        <div class="presses_box">
                            <div class="presses_box_1"></div>
                        </div>
                        <div class="presses_num">
                            90%
                        </div>
                    </div>
                </div>
        ...
        <div class="courier">
            <div class="courier_way">
                配送方式：由顺丰快递配送
            </div>
            <div class="courier_num">
                运单号: 331098762738382
            </div>
        </div>
        <div class="receipt_info">
            <div class="receipt_man">
                <div class="people">张三丰</div>
                <div class="phone">18876545678</div>
            </div>
            <div class="receipt_address">
                浙江省杭州市萧山区白云街道白云路66号杭州湾信息港
            </div>
        </div>
        <div class="button">
            <div class="cancel">取消订单</div>
            <div class="pay" @click="sure_raise">去付款</div>
        </div>
    </div>
</template>
<script>
